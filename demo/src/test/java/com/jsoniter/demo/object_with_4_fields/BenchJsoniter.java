...
BenchJsoniter.deser  thrpt    5   9671700.493 ± 361970.552  ops/s (2.32x)
BenchJsoniter.ser    thrpt    5  16048635.603 ±  76492.866  ops/s (2.77x)
 */
@State(Scope.Thread)
public class BenchJsoniter {
    ...
    public static void main(String[] args) throws IOException, RunnerException {
        Main.main(new String[]{
                "object_with_4_fields.BenchJsoniter",
                "-i", "5",
                "-wi", "5",
                "-f", "1",
        });
